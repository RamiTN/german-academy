<x-app-layout>
    <x-slot:header>Schedules</x-slot>

    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Class Schedules</h2>
            <p class="text-sm text-gray-500 mt-1">View and manage all scheduled lessons and meetings.</p>
        </div>
    ...
    <x-ui.card>
        <div class="p-8 text-center">
            <div class="flex flex-col items-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-1">No scheduled lessons</h3>
                <p class="text-gray-500 text-sm max-w-sm">Schedule your first lesson and it will appear here in a calendar view.</p>
            </div>
        </div>
    </x-ui.card>
</x-app-layout>
