<x-app-layout>
    <x-slot:header>Teachers</x-slot>

    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">All Teachers</h2>
            <p class="text-sm text-gray-500 mt-1">Manage your teaching staff and their class assignments.</p>
        </div>
                    ...
                    <tr>
                        <td colspan="5" class="px-4 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 mb-1">No teachers yet</h3>
                                <p class="text-gray-500 text-sm max-w-sm">Teachers will appear here once they are registered and approved.</p>
                            </div>
                        </td>
                    </tr>
                </tbody>
