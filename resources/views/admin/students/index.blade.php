<x-app-layout>
    <x-slot:header>Students</x-slot>

    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">All Students</h2>
            <p class="text-sm text-gray-500 mt-1">Manage enrolled students across all class groups.</p>
        </div>
                    ...
                    <tr>
                        <td colspan="6" class="px-4 py-16 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 mb-1">No students yet</h3>
                                <p class="text-gray-500 text-sm max-w-sm">Students will appear here once they are enrolled and assigned to class groups.</p>
                            </div>
                        </td>
                    </tr>
                </tbody>
