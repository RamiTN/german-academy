<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="mb-6 flex items-center justify-between">
            ...
            <a href="{{ route('admin.homework.index') }}" class="btn-secondary text-sm">&larr; {{ __('Back') }}</a>
        </div>

        <x-ui.card class="p-6">
            <form action="{{ route('admin.homework.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="instructions" id="instructions" rows="5" required class="input"></textarea>
                </div>
