<x-app-layout>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            <x-ui.card header="Recent Applications">
                            ...
                            @forelse($recentApplications as $app)
                                <tr class="border-b border-gray-100 hover:bg-gray-50/50">
                                    ...
                                    <td class="px-4 py-3 text-end">
                                        <a href="#" class="text-accent hover:text-accent-hover font-medium">Review</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-8 text-center text-gray-500">No recent applications.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div>
            <x-ui.card header="Quick Actions">
                <div class="space-y-3">
                    <a href="#" class="flex items-center p-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 border border-gray-100 group">
