<x-app-layout>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Broadcast important updates to students and class groups.</p>
        </div>
    ...
    <x-ui.card>
        <div class="p-8 text-center">
            <div class="flex flex-col items-center">
                ...
                <p class="text-gray-500 text-sm max-w-sm">Create your first announcement to keep students informed about important updates.</p>
            </div>
        </div>
    </x-ui.card>
</x-app-layout>
