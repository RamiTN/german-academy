    ...
    <div class="bg-white py-16 sm:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <h1 class="text-4xl font-bold text-gray-900 tracking-tight sm:text-5xl mb-6">{{ __('About the Teacher') }}</h1>
                ...
                <div class="relative">
                    <div class="aspect-[4/5] rounded-3xl overflow-hidden bg-gray-100 relative z-10 shadow-xl">
                        <img src="{{ asset('images/teacher.jpeg') }}" alt="Our Teacher" class="absolute inset-0 w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-tr from-accent/20 to-transparent opacity-50 mix-blend-multiply pointer-events-none"></div>
                    </div>
