<x-app-layout>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Share materials and resources with your classes.</p>
        </div>
    ...
    <x-ui.card>
        <div class="p-8 text-center">
            <div class="flex flex-col items-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-1">No resources uploaded</h3>
                <p class="text-gray-500 text-sm max-w-sm">Upload files and links to share with your students.</p>
            </div>
        </div>
    </x-ui.card>
</x-app-layout>
