<x-app-layout>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">{{ __('Broadcast updates to your class groups.') }}</p>
        </div>
        <a href="{{ route('teacher.announcements.create') }}" class="btn-primary text-sm">
        ...
        @else
            <div class="p-8 text-center">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-500 text-sm max-w-sm mb-4">{{ __('Create your first announcement to keep your students informed.') }}</p>
                    <a href="{{ route('teacher.announcements.create') }}" class="btn-primary text-sm py-2 px-4">{{ __('New Announcement') }}</a>
                </div>
            </div>
        @endif
    </x-ui.card>
